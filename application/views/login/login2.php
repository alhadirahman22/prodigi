                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            <h1><strong>JST Google</strong> Login Form</h1>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                            ...
                            <div class="form-bottom">
			                    <form role="form" action="login" method="post" class="login-form">
                                    <!-- Pesan Start -->
                                      <?php
                                        ...
                                        <div class="alert alert-danger alert-dismissible" role="alert">
                                          ...
                                          <strong>Warning!</strong> <?php echo $pesan; ?>
                                        </div>
                                        <?php endif ?>
                                    <!-- Pesan Exit -->
                                    ...
                                    <div class="form-group">
                                        <?php if (($this->session->userdata('wrong') > 5) && ($this->session->userdata('wrong') != '')): ?>
                                            <?php echo $image; ?>
                                    </div>  
                                    <div class="form-group">
                                          <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Captcha" name ="captcha">
                                              <?php if ($messages_captcha != ''): ?>
                                                <div class="alert alert-danger" role="alert"><?php echo $messages_captcha ?><a href="#" class="alert-link"></a></div>
                                              <?php endif ?>
                                    </div> 
                                        <?php endif ?>
                                    <hr>
